//unitedhrpov.service-now.com/cti.do?sysparm_cti_rule=united_hr_cti&sysparm_caller_phone=09492818574

URL: https: function united_hr_cti() {
  var url = null;
...
function locateUser(phone) {
  ...
  userGr.addQuery('phone', phone).addOrCondition('mobile_phone', phone);
  userGr.query();
  if (userGr.next()) {
