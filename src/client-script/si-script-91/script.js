function onChange(control, oldValue, newValue, isLoading) {
  ...
  if (newValue != '') {
    ...
    if (ga.getAnswer() == 'true') {
      g_form.showFieldMsg(
        'Enterprise_App',
        'An active application account has been found for this user.  If your account is locked out or you have forgotten your password, please use the Password Reset Request. Otherwise, provide a reason for the application account update below.',
        'info'
      );
